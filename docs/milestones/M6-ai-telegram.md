...
- [ ] Bot Terminal icon restored in Voll-OS dock (depends on M3)
...
- [ ] `[D]` Voll-OS Bot Terminal icon feature-flag flip — **BLOCKED:** at least 3 bridges live.
...
- Progress: 3/10 done — all 3 Ready-bucket items written 2026-05-20. Remaining 7 are Blocked-bucket wiring (Claude + Telegram are buildable now off the spec; Lobster/OpenClaw/Hermes need partner access; icon flip gated on ≥3 bridges live).
- Blockers active: 7
- Scheduled today: 0

## Notes

- M6 builds on M3 (Bot Terminal UI scaffold restored) and M2 (Coach as a Claude-backed bridge).
